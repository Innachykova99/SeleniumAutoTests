...
public class SeleniumWebDriverTest
{
    ...
    public void FindAndNavigateToRelatedProduct() //find in Related Products 'HTML5 WebApp Develpment' and navigate to it
    {
        ...
        IWebElement RelatedProduct = webDriver.FindElement(By.CssSelector("li a.woocommerce-LoopProduct-link[href = 'https://practice.automationtesting.in/product/html5-webapp-develpment/']")); // css: li a.woocommerce-LoopProduct-link
